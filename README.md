# Blockchain-in-Cpp (데모 모드)

블록체인을 직접 설계·구현하면서 **“왜 블록체인인가?”** 를 체험하는 미니 프로젝트입니다. 백엔드(C++17) + 프런트(React)로 구성되며, P2P 전파를 보기 쉽도록 해시 검증을 끈 **trust 모드**로 동작합니다. (데모 목적, 보안/무결성용 아님)
